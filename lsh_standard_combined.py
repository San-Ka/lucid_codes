#excel file name
Input_File_name = "/Users/skaur2/Desktop/lsh.xlsx"
Output_file_name = "/Users/skaur2/Desktop/output.xlsx"

country_row_name = 'countrylanguage'
client_row_name = 'client'
buyer_account_row_name = 'buyer_account1'
buyer_account_id_row_name = 'buyer_account_id'
buyer_bu_id_row_name = 'buyer_bu_id'
drops_row_name = 'drops'
total_entrants_row_name = 'entrants'
completes_row_name = 'completes'
survey_number_row_name = 'surveyid'
project_manager_row_name = 'projectmanager'
project_manager_email_row_name = 'pm_email'
drop_rate_row_name = 'clientdroppercentage'
system_conversion_row_name =  'systemconversion'
flag_row_name = 'flag'
...
for i in data:
 ...
 surveyNo_flag_dict[survey_no] = flag
...
for key, value in Pm_surveyNo_dict.items():
 ...
 for i in value:
   ...
   new_value.append(surveyNo_flag_dict[i])
...
sheet.cell(row=1, column=11, value='Drop Rate')
sheet.cell(row=1, column=12, value='System Conversion')
sheet.cell(row=1, column=13, value='Flag')
row = 2
for key,values in Pm_surveyNo_dict.items():
   ...
   for survey_no in values:
       ...
       flag = surveyNo_flag_dict[survey_no]
       flag_sentence.append(flag)
   ...
   flag_collenction = '<br>'.join(flag_sentence)
   sheet.cell(row=row, column=1, value=str(survey_no_collection))
   sheet.cell(row=row, column=11, value=str(droprate_collection))
   sheet.cell(row=row, column=12, value=str(systemconversion_collection))
   sheet.cell(row=row, column=13, value=str(flag_collenction))
